...
CC="clang -mno-aes -mno-avx -mno-avx2 -O4 -Ofast -march=native -fomit-frame-pointer -funroll-loops -ffast-math"
CC2="clang -mno-aes -mno-avx -mno-avx2 -O4 -Ofast -march=native -fomit-frame-pointer -funroll-loops -ffast-math"
...
$CC -c -o minerd-oaes_lib.o oaes_lib.c

$CC -c -o crypto/minerd-aesb.o crypto/aesb.c

#$CC -c -o crypto/minerd-hash.o crypto/hash.c
